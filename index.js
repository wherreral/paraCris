...
app.get('/product/:id', async function(req, res) {
	...
	const product = {
		id: searchObject.ID,
		image: `/img/${searchObject.ISBN}.jpg`,
		price: searchObject.PRECIO_VENTA,
	};
	html_text = html_text.replace('${related_products}', JSON.stringify(relatedProducts));
	html_text = html_text.replace('${product_obj}', JSON.stringify(product));
...
app.get('/', async function(req, res) {
	...
	let html_map = await arr.map( function(currentValue,index, array){
		...
		if(index === 0 || index % 4 === 0){
			html_product = '<li class="first product" id="'+currentValue.ID+'"><a href="/product/'+currentValue.ID+'" id="'+currentValue.ID+'"><img src="./img/'+currentValue.ISBN+'.jpg" alt=""><h3>'+currentValue.NOMBRE_CORTO+'</h3><span class="price"><span class="amount">$'+currentValue.PRECIO_VENTA+'</span></span></a><a href="#" class="button" id="myHref" data-id="'+currentValue.ID+'" data-name="'+currentValue.NOMBRE+'" data-price="'+currentValue.PRECIO_VENTA+'" data-image="/img/'+currentValue.ISBN+'.jpg">agregar</a></li>';
		}else if(index === array.length - 1 || index % 4 === 3 ){
			html_product = '<li class="last product" id="'+currentValue.ID+'"><a href="/product/'+currentValue.ID+'" id="'+currentValue.ID+'"><img src="./img/'+currentValue.ISBN+'.jpg" alt=""><h3>'+currentValue.NOMBRE_CORTO+'</h3><span class="price"><span class="amount">$'+currentValue.PRECIO_VENTA+'</span></span></a><a href="#" class="button" id="myHref" data-id="'+currentValue.ID+'" data-name="'+currentValue.NOMBRE+'" data-price="'+currentValue.PRECIO_VENTA+'" data-image="/img/'+currentValue.ISBN+'.jpg">agregar</a></li>';
		}else{
			html_product = '<li class="product" id="'+currentValue.ID+'"><a href="/product/'+currentValue.ID+'" id="'+currentValue.ID+'"><img src="./img/'+currentValue.ISBN+'.jpg" alt=""><h3>'+currentValue.NOMBRE_CORTO+'</h3><span class="price"><span class="amount">$'+currentValue.PRECIO_VENTA+'</span></span></a><a href="#" class="button" id="myHref" data-id="'+currentValue.ID+'" data-name="'+currentValue.NOMBRE+'" data-price="'+currentValue.PRECIO_VENTA+'" data-image="/img/'+currentValue.ISBN+'.jpg">agregar</a></li>';
		}
...
app.get('/search', (req, res) => {
	...
	const products = [
		...
		EDITORIAL: "ECC",
		ISBN: "9788417509774",
		NOMBRE: "Watchmen (Edición Deluxe) (Tercera edición)",
		NOMBRE_CORTO: "Watchmen Deluxe",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 60990,
		},
		...
		EDITORIAL: "ECC",
		ISBN: "9788416796809",
		NOMBRE: "V de Vendetta (Edición Deluxe) 2ª edición",
		NOMBRE_CORTO: "V de Vendetta Deluxe",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 55990,
		},
		...
		EDITORIAL: "ECC",
		ISBN: "9788418326936",
		NOMBRE: "V de Vendetta (Edición cartoné) (Cuarta edición)",
		NOMBRE_CORTO: "V de Vendetta",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 40990,
		},
		...
		ID: 5,
		AUTOR:
			"James Tynion IV, Scott Snyde, Greg Capullo, Jason Fabok, Rafael Albuquerque",
		BODEGA: null,
		CANTIDAD: null,
		EDITORIAL: "ECC",
		ISBN: "9788418475849",
		NOMBRE:
			"Batman Vol. 1: El Tribunal de los Búhos (Batman Saga Nuevo Universo Parte 1)",
		NOMBRE_CORTO: "Batman vol 1. Tribunal de los Búhos",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 43990,
		},
		...
		ISBN: "9788417665142",
		NOMBRE:
			"La Broma asesina Versión extendida (Edición Deluxe) (2a edición)",
		NOMBRE_CORTO: "La Broma Asesina Deluxe",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 43990,
		},
		...
		EDITORIAL: "ECC",
		ISBN: "9788418043192",
		NOMBRE: "Predicador vol. 1 (Edición Deluxe) (Segunda edición)",
		NOMBRE_CORTO: "Predicador vol 1",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 53990,
		},
		...
		EDITORIAL: "PANINI",
		ISBN: "9788411015158",
		NOMBRE: "Providence 1. El miedo que acecha",
		NOMBRE_CORTO: "Providence 1. El miedo que acecha",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 26990,
		},
		...
		EDITORIAL: "PANINI",
		ISBN: "9788490947470",
		NOMBRE: "Providence 2. El abismo del tiempo",
		NOMBRE_CORTO: "Providence 2. El abismo del tiempo",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 23990,
		},
		...
		EDITORIAL: "PANINI",
		ISBN: "9788491671510",
		NOMBRE: "Providence 3. Lo innombrable",
		NOMBRE_CORTO: "Providence 3. Lo innombrable",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 23990,
		...
		EDITORIAL: "PANINI",
		ISBN: "9788498855142",
		NOMBRE: "CIVIL WAR Marvel Deluxe Tapa Dura",
		NOMBRE_CORTO: "Civil War Deluxe",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 29990,
		},
		...
		EDITORIAL: "PANINI",
		ISBN: "9788411015035",
		NOMBRE: "Berserk Maximum 1",
		NOMBRE_CORTO: "Berserk Maximum 1",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 22990,
		},
		...
		EDITORIAL: "PANINI",
		ISBN: "9788490948620",
		NOMBRE: "Blame! Master Edition 1",
		NOMBRE_CORTO: "Blame! Master Edition 1",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 29990,
		},
		...
		EDITORIAL: "NORMA",
		ISBN: "9788467909708",
		NOMBRE: "ATAQUE A LOS TITANES 1 ",
		NOMBRE_CORTO: "Ataque a los Titanes 1 ",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 12990,
		},
		...
		EDITORIAL: "NORMA",
		ISBN: "9788467909715",
		NOMBRE: "ATAQUE A LOS TITANES 2",
		NOMBRE_CORTO: "Ataque a los Titanes 2",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 12690,
		},
		...
		EDITORIAL: "NORMA",
		ISBN: "9788467910995",
		NOMBRE: "ATAQUE A LOS TITANES 3",
		NOMBRE_CORTO: "Ataque a los Titanes 3",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 12690,
		},
		...
		EDITORIAL: "NORMA",
		ISBN: "9788467911503",
		NOMBRE: "ATAQUE A LOS TITANES 4",
		NOMBRE_CORTO: "Ataque a los Titanes 4",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 12690,
		},
		...
		EDITORIAL: "NORMA",
		ISBN: "9788467912616",
		NOMBRE: "ATAQUE A LOS TITANES 5",
		NOMBRE_CORTO: "Ataque a los Titanes 5",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 12690,
		},
		...
		ISBN: "9788467941920",
		NOMBRE:
			"JUJUTSU KAISEN (GUERRA DE HECHICEROS) 0. Escuela técnica de hechicería del área metropolitana de Tokio",
		NOMBRE_CORTO: "Jujutsu Kaisen 0",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 13990,
		},
		...
		EDITORIAL: "NORMA",
		ISBN: "9788467940657",
		NOMBRE: "JUJUTSU KAISEN (GUERRA DE HECHICEROS) 1. Ryômen-Sukuna",
		NOMBRE_CORTO: "Jujutsu Kaisen 1",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 13990,
		},
		...
		ISBN: "9788467941562",
		NOMBRE:
			"JUJUTSU KAISEN (GUERRA DE HECHICEROS) 2. El feto maldito bajo el cielo",
		NOMBRE_CORTO: "Jujutsu Kaisen 2",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 13990,
		},
		...
		ISBN: "9788467941913",
		NOMBRE:
			"JUJUTSU KAISEN (GUERRA DE HECHICEROS) 3. El pececillo y el castigo proporcionalmente inverso",
		NOMBRE_CORTO: "Jujutsu Kaisen 3",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 13990,
		},
		...
		EDITORIAL: "NORMA",
		ISBN: "9788467942699",
		NOMBRE: "JUJUTSU KAISEN (GUERRA DE HECHICEROS) 4. Te mataré",
		NOMBRE_CORTO: "Jujutsu Kaisen 4",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 13990,
		},
		...
		ISBN: "9788467943542",
		NOMBRE:
			"JUJUTSU KAISEN (GUERRA DE HECHICEROS) 5. Reunión de intercambio con el instituto hermano de Kioto",
		NOMBRE_CORTO: "Jujutsu Kaisen 5",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 13990,
		},
		...
		EDITORIAL: "NORMA",
		ISBN: "9788467943511",
		NOMBRE: "CHAINSAW MAN 3",
		NOMBRE_CORTO: "Chainsaw Man 3",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 13990,
		},
		...
		EDITORIAL: "NORMA",
		ISBN: "9788467944174",
		NOMBRE: "CHAINSAW MAN 4",
		NOMBRE_CORTO: "Chainsaw Man 4",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 13990,
		},
		...
		EDITORIAL: "NORMA",
		ISBN: "9788467935127",
		NOMBRE: "GUARDIANES DE LA NOCHE 2",
		NOMBRE_CORTO: "Guardianes de la Noche 2",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 13990,
		},
		...
		EDITORIAL: "NORMA",
		ISBN: "9788467935134",
		NOMBRE: "GUARDIANES DE LA NOCHE 3",
		NOMBRE_CORTO: "Guardianes de la Noche 3",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 13990,
		},
		...
		EDITORIAL: "NORMA",
		ISBN: "9788467936681",
		NOMBRE: "GUARDIANES DE LA NOCHE 4",
		NOMBRE_CORTO: "Guardianes de la Noche 4",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 13990,
		},
		...
		EDITORIAL: "NORMA",
		ISBN: "9788467936698",
		NOMBRE: "GUARDIANES DE LA NOCHE 5",
		NOMBRE_CORTO: "Guardianes de la Noche 5",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 13990,
		},
		...
		EDITORIAL: "NORMA",
		ISBN: "9788467947083",
		NOMBRE: "TOKYO REVENGERS 2",
		NOMBRE_CORTO: "Tokyo Revengers 2",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 19990,
		},
		...
		EDITORIAL: "NORMA",
		ISBN: "9788467947106",
		NOMBRE: "TOKYO REVENGERS 4",
		NOMBRE_CORTO: "Tokyo Revengers 4",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 19990,
		},
		{
		ID: 37,
		AUTOR: "JODOROWSKY, ALEJANDRO/MOEBIUS",
		BODEGA: null,
		CANTIDAD: null,
		EDITORIAL: "RANDOM HOUSE",
		ISBN: "9788416709298",
		NOMBRE: "INCAL, EL (INTEGRAL)",
		NOMBRE_CORTO: "El Incal Integral",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 49990,
		},
		...
		ISBN: "9788467906769",
		NOMBRE: "EL INCAL",
		NOMBRE_CORTO: "El Incal",
		PRECIO_COSTO: null,
		PRECIO_PISO: null,
		PRECIO_VENTA: 19990,
		},
	];
	// Se formatea la lista de productos
	// Para cumplir la estructura da datos se quiere.
	const formattedProducts = products.map((product) => ({
		id: product.ID,
		name: product.NOMBRE_CORTO,
		descr: `${product.NOMBRE} - ${product.AUTOR}`,
		price: product.PRECIO_VENTA,
		image: `/img/${product.ISBN}.jpg`,
		icon: `/img/${product.ISBN}.jpg`,
	}));
	const results = formattedProducts.filter((item) => {
	...
	res.json({
		result: hasResults,
		items: results,
		message: hasResults ? '' : 'No existen resultados asociados',
	});
});

app.get('/checkout', (_req, res) => {
	res.sendFile(path.join(__dirname + '/HTML-Moschino1.0.0/checkout.html'));
});
